...
import com.yey.databinding.ActivityYSelectTvBinding;
import com.yey.vm.YSelectTextViewVM;
import com.yey.ycustomeview.YSelectTextView;

public class YSelectTextViewActivity extends AppCompatActivity {
    ActivityYSelectTvBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = (ActivityYSelectTvBinding) DataBindingUtil.setContentView(this, R.layout.activity_y_select_tv);
        ...
        binding.btnPrintData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(YSelectTextViewActivity.this, mVM.mChangeContent.get(), Toast.LENGTH_LONG).show();
            }
        });
    }
}